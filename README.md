...
This package provides **Bitunix exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITUNIX** exchange.
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bitunix exchange plugin for bt_api**。它提供了与 **BITUNIX** 交易所交互的统一接口。
